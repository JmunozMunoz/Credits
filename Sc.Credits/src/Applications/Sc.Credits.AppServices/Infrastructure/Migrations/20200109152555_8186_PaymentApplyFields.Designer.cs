...
namespace Sc.Credits.Applications.AppServices.Infrastructure.Migrations
{
    ...
    [Migration("20200109152555_8186_PaymentApplyFields")]
    partial class _8186_PaymentApplyFields
    {
            ...
            modelBuilder.Entity("Sc.Credits.Domain.Model.Credits.Credit", b =>
                {
                    ...
                    b.Property<int>("ComputedArrearsDays")
                        ...
                        .HasComputedColumnSql("(CASE WHEN DATEDIFF(DAY,(CASE WHEN [DueDate] > [LastPaymentDate] THEN [DueDate] ELSE [LastPaymentDate] END),GETDATE()) <= 0 THEN 0 ELSE DATEDIFF(DAY,(CASE WHEN [DueDate] > [LastPaymentDate] THEN [DueDate] ELSE [LastPaymentDate] END),GETDATE()) END)");
