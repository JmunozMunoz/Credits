...
namespace Sc.Credits.EntryPoints.ReactiveWeb.Controllers.V1
{
    ...
    public class CreditController : AppControllerBase<CreditController>
    {
        ...
        /// <summary>
        /// Get customer credit limit without vendor id
        /// </summary>
        /// <param name="typeDocument"></param>
        /// <param name="idDocument"></param>
        /// <returns></returns>
        [HttpGet]
        [ActionName("GetCustomerCreditLimitIncrease")]
        public async Task<IActionResult> GetCustomerCreditLimitIncrease(string typeDocument, string idDocument) =>
            await HandleRequestAsync(async () => await _creditService.GetCustomerCreditLimitIncreaseAsync(typeDocument, idDocument),
                idDocument);
        ...
        public async Task<IActionResult> GetCreditToken([FromQuery] GenerateTokenRequest generateTokenRequest) =>
            await HandleRequestAsync(async () =>
            {
                TokenResponse tokenResponse = await _creditService.GenerateTokenWithRiskLevelCalculationAsync(generateTokenRequest);
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<IActionResult> GetCompleteCreditsData(string typeDocument, string idDocument, DateTime calculationDate) =>
            await HandleRequestAsync(async () =>
                     await _creditPaymentService.GetCompleteCreditsDataAsync(typeDocument, idDocument, calculationDate),
                idDocument);
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> GetDetailedActiveCreditsByCreditMasterId(List<Guid> creditMastersId, DateTime calculationDate) =>
            await HandleRequestAsync(async () =>
                    await _creditPaymentService.GetDetailedActiveCreditsByCreditMasterIdAsync(creditMastersId, calculationDate),
        ...
        /// <summary>
        /// Verifies the recent creation of credit in a customizable time
        /// </summary>
        /// <param name="createCreditRequest"></param>
        /// <returns>a create credit response with the found credit</returns>
        [HttpPost]
        public async Task<IActionResult> GetRecentCreditByToken([FromBody] VerifyCreditCreationRequest createCreditRequest) =>
            await HandleRequestAsync(async () => await _creditService.GetRecentCreditByToken(createCreditRequest),
            createCreditRequest.IdDocument);

        /// <summary>
        /// Updates the credit request by agent
        /// </summary>
        /// <param name="creditRequestAnalysis"></param>
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> UpdateCreditRequestByAgent([FromBody] CreditRequestAnalysis creditRequestAnalysis) =>
            await HandleRequestAsync(async () => await _creditService.UpdateCreditRequestByAgent(creditRequestAnalysis),
            creditRequestAnalysis.CustomerIdDocument);

        /// <summary>
        /// Get TokenSending Authorization Registration
        /// </summary>
        /// <param name="creditRequestId"></param>
        /// <returns></returns>
        [HttpGet]
        public async Task<IActionResult> ExistCreditRequest([FromQuery] Guid creditRequestId) =>
            await HandleRequestAsync(async () => await _creditService.ExistCreditRequestById(creditRequestId),
