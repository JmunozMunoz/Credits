...
{
    public class CustomerUpdateEventSuscriptionTest
    {
        ...
        private readonly Mock<ILoggerService<CustomerUpdateEventSubscription>> _loggerServiceMock =
            new Mock<ILoggerService<CustomerUpdateEventSubscription>>();

        private ICustomerUpdateEventSubscription CustomerEventSuscription =>
            new CustomerUpdateEventSubscription(_customerServiceMock.Object,
                _directAsyncCustomerRequestMock.Object,
                _commonsMock.Object,
                _loggerServiceMock.Object);

        public CustomerUpdateEventSuscriptionTest()
        {
