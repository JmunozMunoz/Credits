...
{
    public class CustomerUpdateStudyEventSuscriptionTest
    {
        ...
        private readonly Mock<ILoggerService<CustomerUpdateStudyEventSubscription>> _loggerServiceMock =
            new Mock<ILoggerService<CustomerUpdateStudyEventSubscription>>();

        private ICustomerUpdateStudyEventSubscription CustomerUpdateStudyEventSuscription =>
            new CustomerUpdateStudyEventSubscription(_customerServiceMock.Object,
                _directAsyncCustomerRequestMock.Object,
                _commonsMock.Object,
                _loggerServiceMock.Object);

        public CustomerUpdateStudyEventSuscriptionTest()
        {
        ...
        public async Task ShouldGetCustomerFromSubscription()
        {
            ...
            await CustomerUpdateStudyEventSuscription.SubscribeAsync();
        ...
        public async Task ShouldInvokeCustomerResponse()
        {
            ...
            _customerServiceMock.Verify(mock => mock.CreateOrUpdateStatusAsync(It.IsAny<CustomerRequest>(), It.IsAny<DateTime>()), Times.Once);
        }
    }
}